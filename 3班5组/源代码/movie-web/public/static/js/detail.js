    ...
    if (video.attr("src") !== undefined){
        video[0].onloadedmetadata = function (e){
            if (video[0].duration !== 0){
                ...
                $("#dTime").text(str);
                intervalIdTime = setInterval(showVideoTime, 10);
                intervalIdSlider = setInterval(changeSlider, 10);
                video[0].play();
                ...
                $(".voiceSound").click(function (e){
                    ...
                    if(sound.text() !== "0%"){
                        ...
                        $(this).attr("src", "/static/img/icon/sound-down.png");
                        sound.text("0%");
                    }
                    else {
                        $(this).attr("src", "/static/img/icon/sound.png");
